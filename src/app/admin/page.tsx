...
export default async function AdminDashboardPage() {
  ...
  const cards = [
    ...
    { labelKey: 'admin.customRequests' as const, hintKey: 'admin.newBespoke' as const, href: '/admin', value: stats.newCustomDesigns, iconKey: 'gift' as const },
    { labelKey: 'admin.messages' as const, hintKey: 'admin.newContacts' as const, href: '/admin', value: stats.newContacts, iconKey: 'certificate' as const },
  ]
